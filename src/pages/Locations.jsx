...
const locationData = {
  noida: {
    title: "Noida",
    description:
      "Noida is a planned city located in the National Capital Region of India, known for its modern infrastructure and rapid urbanization.",
    images: [noida, noida2, noida3],
    features: [
  ...
  delhi: {
    title: "Delhi",
    description:
      "Delhi is the capital territory of India, and a massive metropolitan area in the country’s north. It is known for its rich history, culture, and landmarks.",
    images: [delhi, delhi2, delhi3],
    features: [
  ...
  kolkata: {
    title: "Kolkata",
    description:
      "Kolkata (formerly Calcutta) is the capital of India’s West Bengal state. It is known for its grand colonial architecture, art galleries, and cultural festivals.",
    images: [kolkata, kolkata2, kolkata3],
    features: [
  ...
  return (
    <div>
      ...
      <div className="max-w-screen-xl mx-auto py-10 px-4">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-semibold text-blue-900 mb-4">
            Why Choose {location.title}?
          </h2>
          <p className="text-lg text-gray-700 mb-4">
            {location.title} is one of the most sought-after locations for real
            estate investment due to its strategic location, rapid growth, and
            diverse opportunities. Whether you're looking for residential or
            commercial properties, {location.title} offers a perfect blend of
            modern amenities and cultural heritage.
          </p>
          <p className="text-lg text-gray-700">
            Explore a wide range of properties that suit your needs and budget,
            and take the next step towards owning your dream property in{" "}
            {location.title}.
          </p>
        </div>
        ...
        <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
          ...
          <p className="text-center text-gray-700 mb-6">
            ...
            properties in {location.title}, feel free to reach out to us.
          </p>
